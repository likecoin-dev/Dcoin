...
std::string HelpMessage()
{
    ...
    strUsage += "  -pid=<file>            " + _("Specify pid file (default: dbcoind.pid)") + "\n";
...
#define PROCESS_DEP_ENABLE 0x00000001
    ...
    if (!lock.try_lock())
        return InitError(strprintf(_("Cannot obtain a lock on data directory %s. Dcoin is probably already running."), strDataDir.c_str()));

    if (GetBoolArg("-shrinkdebugfile", !fDebug))
        ShrinkDebugFile();
    printf("\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n");
    printf("Dcoin version %s (%s)\n", FormatFullVersion().c_str(), CLIENT_DATE.c_str());
