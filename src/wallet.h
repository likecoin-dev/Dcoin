...
public:
    ...
    /** Get the wallet's activity log                                           Получить журнал активности кошелька
        @return multimap of ordered transactions and accounting entries         @return MultiMap упорядоченной операций и бухгалтерских проводок
        @warning Returned pointers are *only* valid within the scope of passed acentries   @warning Возвращается указатели *только* действительны в рамках прошедшего acentries
     */
