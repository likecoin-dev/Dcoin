    ...
    while (pcursor->Valid()) {
        ...
        try {
            ...
            if (chType == 'b') {
                ...
                pindexNew->Dbase[0]       = diskindex.Dbase[0];       ////////// новое //////////
                pindexNew->Dbase[1]       = diskindex.Dbase[1];       ////////// новое //////////
                pindexNew->coinDs[0]      = diskindex.coinDs[0];      ////////// новое //////////
                pindexNew->coinDs[1]      = diskindex.coinDs[1];      ////////// новое //////////
