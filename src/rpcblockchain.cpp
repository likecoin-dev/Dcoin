...
Object blockToJSON(const CBlock& block, const CBlockIndex* blockindex)
{
    ...
    //result.push_back(Pair("_|_Dbase", (boost::uint64_t)block.Dbase));          ////////// новое //////////
    //result.push_back(Pair("_|_coinDs", (boost::uint64_t)block.coinDs));        ////////// новое //////////
    result.push_back(Pair("_|_Dbase[0]", ValueFromAmount(block.Dbase[0])));          ////////// новое //////////
    result.push_back(Pair("_|_Dbase[1]", ValueFromAmount(block.Dbase[1])));          ////////// новое //////////
    result.push_back(Pair("_|_coinDs[0]", ValueFromAmount(block.coinDs[0])));        ////////// новое //////////
    result.push_back(Pair("_|_coinDs[1]", ValueFromAmount(block.coinDs[1])));        ////////// новое //////////
